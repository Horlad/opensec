...
export namespace Flag {
  ...
  export const OPENCODE_MCP_OAUTH_CALLBACK_PORT = number("OPENCODE_MCP_OAUTH_CALLBACK_PORT")
  export const OPENCODE_MCP_OAUTH_CALLBACK_HOST = process.env["OPENCODE_MCP_OAUTH_CALLBACK_HOST"]
  export const OPENCODE_CODEX_OAUTH_HOST = process.env["OPENCODE_CODEX_OAUTH_HOST"]
