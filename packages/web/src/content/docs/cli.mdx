...
| `OPENCODE_DISABLE_APPLE_CONTAINER`    | boolean | Disable Apple container runtime                   |
| `OPENCODE_FORCE_APPLE_CONTAINER`      | boolean | Force Apple container runtime                     |
| `OPENCODE_APPLE_CONTAINER_IMAGE`      | string  | Override Apple container image                    |
| `OPENCODE_APPLE_CONTAINER_BINARY`     | string  | Override Linux binary path used in container mode |
