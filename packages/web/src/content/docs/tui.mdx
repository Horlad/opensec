...
Configure proxying for code and CLI command execution traffic. OpenCode's own LLM/API requests stay direct. [Learn more](/docs/network#proxy).
...
Open certificate manager to list, add, and remove managed CA certificates. _Alias_: `/certs`
